google.maps.__gjsload__('search', function (_) {
  var Sxa = function (a) {
    ...
    Rxa = function (a) {
      let b = _.np,
        c = -1;
      a.tiles.forEach((e) => {
        e.zoom > c && ((b = e.fj), (c = e.zoom));
      });
      if (c === -1) return [];
      const d = [];
      a.Sv().forEach((e) => {
        e.a && e.a.length >= 2 && d.push(new Txa(e, b, c));
      });
      return d;
    },
    Uxa = class extends _.fo {};
  var Vxa = { ['1']: {} },
    Txa = class {
      constructor(a, b, c) {
        this.Bo = b;
      ...
      getAnchor() {
        if (!this.anchor) {
          ...
          this.anchor = _.Mr(
            new _.ar(
              (this.Bo.x * 256 + this.source.a[0]) / a,
              (this.Bo.y * 256 + this.source.a[1]) / a
            )
          ).toJSON();
        }
        return this.anchor;
  ...
  _.Ho(EH.prototype, { map: _.jt });
  _.ya.google.maps.search = { GoogleLayer: EH };
  _.Xl('search', {});
});
